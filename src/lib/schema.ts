...
export const tables: Record<string, TableSchema> = {
  ...
  standard_equipment_items: {
    ...
    fields: [
      ...
      { name: 'graphics_card',   label: 'Placa Gráfica',       type: 'text',    nullable: true },
      { name: 'conveyor_belt_load_capacity_kg', label: 'Cap. Correia (kg)',   type: 'text', nullable: true },
      ...
      { name: 'conveyor_belt_type', label: 'Tipo Correia',     type: 'text',    nullable: true },
  ...
  accessories: {
    ...
    fields: [
      ...
      { name: 'color',                    label: 'Cor',                  type: 'text',    nullable: true },
      { name: 'predominant_material',    label: 'Material Predom.',     type: 'text',    nullable: true },
