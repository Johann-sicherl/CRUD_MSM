...
export const FORCE_TO_ONE_FIELDS = [
  ...
  'international_contribution_margin_ratio',
  'seller_commission',
  'manager_commission',
  'director_commission',
  'certification_cost',
...
export const tables: Record<string, TableSchema> = {
  ...
  equipments: {
    ...
    fields: [
      ...
      { name: 'international_contribution_margin_ratio', label: 'Marg. Intl. (%)', type: 'decimal', nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      ...
      { name: 'certification_cost',  label: 'Custo Certif. (R$)', type: 'decimal', nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
  ...
  standard_equipment_items: {
    ...
    fields: [
      ...
      { name: 'graphics_card',   label: 'Placa Gráfica',       type: 'text',    nullable: true, dynamicOptions: 'graphics_card' },
      { name: 'conveyor_belt_load_capacity_kg', label: 'Cap. Correia (kg)',   type: 'text', nullable: true, dynamicOptions: 'belt_load_capacity' },
      ...
      { name: 'conveyor_belt_type', label: 'Tipo Correia',     type: 'text',    nullable: true, dynamicOptions: 'belt_type' },
      ...
      { name: 'color',           label: 'Cor',                 type: 'text',    nullable: true, dynamicOptions: 'equip_color' },
  ...
  non_combinable_comps: {
    ...
    fields: [
      ...
      { name: 'legacy_group_id', label: 'Grupo', type: 'number', nullable: false, showInList: true, hideInForm: true,
        lookupFrom: { table: 'accessory_groups', keyField: 'legacy_id', displayField: 'name' } },
      { name: 'protheus_code', label: '1° Código', type: 'text', nullable: false, showInList: true, listFilterType: 'text', noBulkEdit: true },
      ...
      { name: 'legacy_second_group_id', label: '2° Grupo', type: 'number', nullable: true, showInList: true, hideInForm: true,
        lookupFrom: { table: 'accessory_groups', keyField: 'legacy_id', displayField: 'name' } },
      { name: 'remove_list_code', label: '2° Código', type: 'text', nullable: false, showInList: true, listFilterType: 'text', noBulkEdit: true },
    ...
    fields: [
      ...
      { name: 'group_name_dep', label: 'Grupo Dependente', type: 'text', nullable: true, showInList: true, hideInForm: true,
        lookupFrom: { table: 'accessories', keyField: 'protheus_code', displayField: 'legacy_group_id', sourceField: 'protheus_item_code',
          through: { table: 'accessory_groups', keyField: 'legacy_id', displayField: 'name' } } },
      { name: 'protheus_item_code', label: 'Cód. Dependente', type: 'text', nullable: false, showInList: true, listFilterType: 'text', noBulkEdit: true },
  ...
  roller_tables: {
    ...
    fields: [
      ...
      { name: 'legacy_equipment_id', label: 'Equipamento', type: 'number', nullable: false, showInList: true, noBulkEdit: true,
        lookupFrom: { table: 'equipments', keyField: 'legacy_id', displayField: 'name' },
        fetchOptions: { table: 'equipments', keyField: 'legacy_id', displayField: 'name' } },
      { name: 'protheus_code', label: 'Código Protheus', type: 'text', nullable: false, showInList: true, noBulkEdit: true },
