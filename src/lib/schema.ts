...
export const tables: Record<string, TableSchema> = {
  ...
  equipments: {
    ...
    fields: [
      ...
      { name: 'status',           label: 'Status',        type: 'select',    nullable: false, defaultValue: 'active', options: ['active', 'inactive'], showInList: true, listFilterType: 'text' },
      { name: 'production_cost',  label: 'Custo Prod. (R$)', type: 'decimal', nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      { name: 'ipi_tax_rate',     label: 'IPI (%)',       type: 'decimal',   nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      { name: 'pis_tax_rate',     label: 'PIS (%)',       type: 'decimal',   nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      { name: 'cofins_tax_rate',  label: 'COFINS (%)',    type: 'decimal',   nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      { name: 'icms_tax_rate',    label: 'ICMS (%)',      type: 'decimal',   nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      { name: 'difal_tax_rate',   label: 'DIFAL (%)',     type: 'decimal',   nullable: false, defaultValue: 0, showInList: true, listFilterType: 'text' },
      ...
      { name: 'image_url',           label: 'Imagem (URL)',   type: 'text',    nullable: true },
  ...
  standard_equipment_items: {
    ...
    fields: [
      ...
      { name: 'name',          label: 'Nome',          type: 'text',    nullable: false, defaultValue: '-', showInList: true, listFilterType: 'text' },
      { name: 'description',   label: 'Descrição',     type: 'textarea',nullable: true },
  ...
  dependant_items: {
    ...
    fields: [
      ...
      { name: 'name',        label: 'Nome',      type: 'text',     nullable: false, defaultValue: '-' },
      { name: 'description', label: 'Descrição', type: 'textarea', nullable: true },
